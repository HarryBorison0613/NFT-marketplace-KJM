...
const CardItem = ({ cardItem, networkError, handleRemoveSellPending, handleSetSellPending, handleTransfer, handleBuyToken }) => {
  ...
  const [buyAmount, setBuyAmount] = useState(Number(cardItem.amount))
  ...
  useEffect(() => {
    if (cardItem.collectionAddress && (cardItem.id !== null || cardItem.id !== undefined)) {
  ...
  useEffect(() => {
    if (cardItem.collectionAddress && (cardItem.id !== null || cardItem.id !== undefined) && contractType) {
      if (contractType === 1) {
        (async () => {
                          ...
                          <div
                            ...
                            <div>
                              <div className="space-y-20">
                                ...
                                <div className="space-y-10">
                                  <p>Estimated Price:</p>
                                  <div>{buyTokenAmount ? (Number(buyAmount) * Number(buyTokenAmount)) / Math.pow(10, buyPaymentToken?.decimals> 0 ? buyPaymentToken?.decimals : 18) : 0}</div>
                                </div>
                                </>
                                }
                                <div className="hr" />
                                ...
                                <button
                                  className="btn btn-primary w-full"
                                  disabled={!approved || pendingBuyApprove || !buyAmount || buyAmount > Number(cardItem.amount)}
                                  onClick={() => {
